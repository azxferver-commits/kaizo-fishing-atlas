...
html = html
  ...
  .replace(/V4\.\d+(?:\.\d+)?[^<]*/g, "APP 1.13 · SECURITY")
...
if (!html.includes('id="bluequestChangePasswordDialog"')) {
  html = html.replace(
    '  <div id="toast" class="toast" role="status"></div>',
    '  <dialog id="bluequestChangePasswordDialog" class="quest-dialog">\n    <div class="dialog-sheet auth-sheet">\n      <div class="dialog-grab"></div>\n      <button class="dialog-close" id="changePasswordClose" aria-label="Cerrar">×</button>\n      <div class="auth-brand"><img src="./bluequest_icon.webp" alt=""><span>BLUEQUEST</span></div>\n      <p class="eyebrow">SEGURIDAD DE CUENTA</p>\n      <h2>Cambiar contraseña</h2>\n      <p class="auth-lead">Confirma tu contraseña actual y elige una nueva. Por seguridad, al terminar cerraremos las sesiones abiertas en otros dispositivos y tendrás que iniciar sesión otra vez.</p>\n      <div class="auth-fields">\n        <input id="currentPassword" type="password" autocomplete="current-password" placeholder="Contraseña actual" />\n        <input id="changeNewPassword" type="password" autocomplete="new-password" placeholder="Nueva contraseña" />\n        <input id="changeNewPasswordConfirm" type="password" autocomplete="new-password" placeholder="Repite la nueva contraseña" />\n      </div>\n      <button class="auth-submit" id="changePasswordSubmit" type="button">Cambiar contraseña</button>\n      <p class="auth-note" id="changePasswordMessage">Usa al menos 8 caracteres.</p>\n    </div>\n  </dialog>\n  <div id="toast" class="toast" role="status"></div>'
  );
}
