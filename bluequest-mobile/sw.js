const CACHE='bluequest-mobile-v2.0.0';
const CORE=['./','./index.html','./manifest.webmanifest','./icons/icon.svg','../blue-quest-atlas-1-80/data.json','../blue-quest-atlas-80-100/data.json'];
